...
type Settings = { showLeagues: boolean; showBooking: boolean; showReservations: boolean; showLessons: boolean; showClasses: boolean; showDoublesRadar: boolean };
...
export function AthletePortalSettingsForm({ settings }: { settings: Settings }) {
  ...
  const fieldNames: Record<keyof Settings, string> = { showLeagues: "showLeagues", showBooking: "showBooking", showReservations: "showReservations", showLessons: "showLessons", showClasses: "showClasses", showDoublesRadar: "showDoublesRadar" };
