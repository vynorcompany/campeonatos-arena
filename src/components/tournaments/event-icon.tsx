...
const paths: Record<EventIconName, ReactNode> = {
  ...
  trophy: (
    <>
      ...
      <path d="M6 6H4v1a4 4 0 0 0 4 4M18 6h2v1a4 4 0 0 1-4 4M12 13v4M8 21h8M9 17h6" />
    </>
  ),
  users: (
    <>
      <circle cx="9" cy="8" r="3" />
      <path d="M3 20v-1a6 6 0 0 1 12 0v1M16 5a3 3 0 0 1 0 6M21 20v-1a6 6 0 0 0-4-5.65" />
    </>
  ),
  calendar: (
    <>
  ...
  "user-plus": (
    <>
      <circle cx="9" cy="8" r="3" />
      <path d="M3 20v-1a6 6 0 0 1 12 0v1M19 8v6M16 11h6" />
    </>
  ),
  clipboard: (
    <>
