...
function super12Href(eventId?: string) {
  return eventId ? `?section=leagues&eventTab=super12&super12=${eventId}` : "?section=leagues&eventTab=super12";
}

export function PublicSuper12({ data, arenaSlug }: { data: Super12Data; arenaSlug: string }) {
  if (!data) return null;
