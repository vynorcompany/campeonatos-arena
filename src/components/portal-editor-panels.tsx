    ...
    <div className="portal-editor-workspace">
      <section className="section-card">
        ...
        <div className="client-portal-settings-list">
          {announcements.map((announcement) => <article key={announcement.id}><div><strong>{announcement.title}</strong><span className="portal-editor-text">{announcement.message}</span></div><SafeActionForm action={togglePortalAnnouncementAction}><input type="hidden" name="announcementId" value={announcement.id} /><SubmitButton label={announcement.active ? "Desativar" : "Ativar"} pendingLabel="Salvando..." className="button button-small" /></SafeActionForm></article>)}
