...
function NavIcon({ name }: { name: IconName }) {
  ...
  const paths: Record<IconName, React.ReactNode> = {
    ...
    whatsapp: <><path fill="#25d366" stroke="#25d366" d="M20.5 11.5a8.5 8.5 0 0 1-12.2 7.6L3.5 20.5l1.4-4.6a8.5 8.5 0 1 1 15.6-4.4Z" /><path stroke="#fff" strokeWidth="1.7" d="M8.4 7.5c-.2-.5-.4-.5-.7-.5H7c-.3 0-.6.1-.8.4-.3.4-1 1.1-1 2.7s1 3.2 1.1 3.4c.2.2 2.1 3.3 5.2 4.5 2.5 1 3 1 3.5.9.7-.1 2.1-.9 2.4-1.7.3-.8.3-1.5.2-1.7-.1-.2-.3-.3-.7-.5l-2.1-1c-.4-.2-.6-.3-.8.2l-.6.7c-.2.2-.4.2-.7.1-1.1-.6-2-1.2-2.8-2.2-.8-.9-1.3-1.9-1.5-2.3-.2-.3 0-.5.1-.6l.5-.6c.2-.2.2-.4.3-.6.1-.2 0-.4 0-.6l-.6-1.6Z" /></>,
