    ...
    <div className="stack-md">
      <header className="page-header">
        <div className="stack-xs">
          ...
          <h1>Novo torneio</h1>
          <p className="muted">Crie o torneio em etapas para manter tudo organizado desde o início.</p>
        </div>
        <Link href="/torneios" className="button">Voltar</Link>
      </header>

      <SectionCard title="Assistente de criação" description="Preencha as etapas e revise antes de criar.">
