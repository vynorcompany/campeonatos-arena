...
function bookingTypeIcon(value: string) { const type = value.trim().toLowerCase(); if (type.includes("aula")) return "♙"; if (type.includes("liga")) return "🏆"; if (type.includes("super 12")) return "S12"; if (type.includes("fixa")) return "◷"; return "🎾"; }
